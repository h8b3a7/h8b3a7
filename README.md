...
![cybersecurity_skills](https://img.shields.io/badge/-%F0%9F%9B%A1%EF%B8%8F%20Cyber%20Security%20%26%20SOC%20Tools-blue)
![semicolon](https://img.shields.io/badge/-%3A-blue)
![Kali Linux](https://img.shields.io/badge/Kali%20Linux-171F26?style=flat&logo=kali-linux&logoColor=white)
...
```cpp
// Cyber Security Student & Future SOC Analyst

class CyberSecurityStudent : public Me { 
public:
    const var myFocus = {  
        "Specialization" : "Cyber Security",
        "Core_Interests" : { "SOC Operations", "Penetration Testing", "Digital Forensics" },
        "OS_Environments": { "Kali Linux", "Ubuntu", "Windows (VMware)" },
        "Networking"     : { "Subnetting", "Cisco Configurations", "Routing Protocols" },
        "Languages_Frameworks" : { "C++", "Qt (GUI)", "Python", "Bash Scripting" },
